...
from api.views import WishListView, WishDetailView, UserCreateAPIView
...
urlpatterns = [
    ...
    path('api/list/', WishListView.as_view(), name='api-list'),
    path('api/<int:item_id>/detail/', WishDetailView.as_view(), name='api-detail'),
